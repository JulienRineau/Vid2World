...
class CSGOLongRolloutVideoLogger(Callback):
    def __init__(self, env=None, log_every_n_train_steps=1000, buffer_size=32, i3d_model_path=None, max_batchsize=2, log_images_kwargs=None, save_dir=None, rollout_steps=100, history_steps=9):
        super().__init__()
        self.env = env
        self.log_every_n_train_steps = log_every_n_train_steps
        self.buffer_size = buffer_size
